...
// DevtoolServiceServer is the server API for DevtoolService service.
// All implementations must embed UnimplementedDevtoolServiceServer
...
// UnimplementedDevtoolServiceServer must be embedded to have
...
// UnsafeDevtoolServiceServer may be embedded to opt out of forward compatibility for this service.
// Use of this interface is not recommended, as added methods to DevtoolServiceServer will
...
func RegisterDevtoolServiceServer(s grpc.ServiceRegistrar, srv DevtoolServiceServer) {
	// If the following call pancis, it indicates UnimplementedDevtoolServiceServer was
...
// DevtoolService_ServiceDesc is the grpc.ServiceDesc for DevtoolService service.
